...
public class HuffmanEncodingTests
{
    ...
    {
        new object[] { false, 25 }, new object[] { true, 22 }
    };

    /// <summary>
    ///     Tests the encoding and decoding of some test strings. The argument source once encodes the strings with reusing
    ///     existing entries, and once without, leading to different result byte lengths.
    /// </summary>
    ...
    public void TextEncodingDecoding(bool compressResults, int encodedByteSize)
    {
        ...
        {
            var decodedText = decoder.ReadHuffmanEncodedString(textId.Position);
