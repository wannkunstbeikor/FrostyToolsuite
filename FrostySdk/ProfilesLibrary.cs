...
public static class ProfilesLibrary
{
    ...
    public static string SdkFilename =>
        s_effectiveProfile is null ? string.Empty : $"{s_effectiveProfile.InternalName}SDK";
    ...
    public static CompressionType TextureChunkCompression =>
        (CompressionType)(s_effectiveProfile?.TextureChunkCompression ?? 0);
    ...
    public static void Initialize()
    {
        ...
        {
            foreach (var file in Directory.EnumerateFiles("Profiles"))
            {
                Profile? profile;
    ...
    public static bool Initialize(string profileKey)
    {
        ...
        {
            foreach (var bundle in s_effectiveProfile.SharedBundles)
            {
